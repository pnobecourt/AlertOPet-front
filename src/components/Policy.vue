<template>
  <div class="container">
    ...
    <section class="box">
      ...
      <p>2. Présentation et principe :</p>
      ...
      <p>
        Le site <strong>www.alertOpet.com </strong>regroupe un ensemble de
        services, dans l’état, mis à la disposition des utilisateurs.
      </p>

      <p>
        Il est ici précisé que ces derniers doivent rester courtois et faire
        preuve de bonne foi tant envers les autres utilisateurs qu’envers le
        webmaster du site www.alertOpet.com.
      </p>

      <p>
        Le site www.alertOpet.com est mis à jour régulièrement par alertOpet.
      </p>

      <p>
        alertOpet s’efforce de fournir sur le site www.alertOpet.com des
      ...
      <p>
        Le site www.alertOpet.com est par principe accessible aux utilisateurs
        24/24h, 7/7j, sauf interruption, programmée ou non, pour les besoins de
        sa maintenance ou en cas de force majeure.
      </p>

      <p>
        En cas d’impossibilité d’accès au service, www.alertOpet.com s’engage à
        faire son maximum afin de rétablir l’accès au service et s’efforcera
        alors de communiquer préalablement aux utilisateurs les dates et heures
        de l’intervention.
      </p>

      <p>
        N’étant soumis qu’à une obligation de moyen, www.alertOpet.com ne
        saurait être tenu pour responsable de tout dommage, quelle qu’en soit la
      ...
      <p>
        alertOpet est propriétaire exclusif de tous les droits de propriété
      ...
      <p>
        Toute reproduction totale ou partielle du site www.alertOpet.com,
        ...
        alertOpet, propriétaire du site à l’email : contact@alertopet.com,
      </p>

      <p>
        à défaut elle sera considérée comme constitutive d’une contrefaçon et
        passible de poursuite conformément aux dispositions des articles L.335-2
      ...
      <p>
        Le site www.alertOpet.com contient un certain nombre de liens
        hypertextes vers d’autres sites (partenaires, informations …) mis en
        place avec l’autorisation de alertOpet.
      </p>

      <p>
        Cependant, alertOpet n’a pas la possibilité de vérifier l’ensemble du
        contenu des sites ainsi visités et décline donc toute responsabilité de
        ce fait quand aux risques éventuels de contenus illicites.
      </p>

      <p>
        L’utilisateur est informé que lors de ses visites sur le site
        www.alertOpet.com, un ou des cookies sont susceptibles de s’installer
      ...
      <p>
        ...
        <a rel="noreferrer noopener" href="http://www.cnil.com" target="_blank"
          >www.cnil.com</a
        >.
      </p>

      <p>
        L’utilisateur peut toutefois configurer le navigateur de son ordinateur
        pour refuser l’installation des cookies, sachant que le refus
      ...
      <p>
        Sur le site www.alertOpet.com, alertOpet ne collecte des informations
        personnelles ( suivant l’article 4 loi n°78-17 du 06 janvier 1978)
        relatives à l’utilisateur que pour le besoin de certains services
        proposés par le site www.alertOpet.com.
      </p>
      ...
      <p>
        Il est alors précisé à l’utilisateur du site www.alertOpet.com
      ...
      <p>
        Pour l’exercer, adressez votre demande à www.alertOpet.com par email :
        <strong
          ><a href="mailto:contact@alertopet.com"
            >contact@alertopet.com</a
          ></strong
        >
        ou par écrit dûment signée, accompagnée d’une copie du titre d’identité
      ...
      <p>
        ...
        www.alertOpet.com n’est publiée à l’insu de l’utilisateur, échangée,
        transférée, cédée ou vendue sur un support quelconque à des tiers.
      </p>

      <p>
        Seule l’hypothèse du rachat du site www.alertOpet.com et de ses droits
        autorise alertOpet à transmettre les dites informations à l’éventuel
