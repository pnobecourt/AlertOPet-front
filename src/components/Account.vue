      ...
      <div class="box">
        <section class="listAnimal" v-if="cardList">
          ...
          <div class="animalCard" v-for="animal in cardList" :key="animal.id">
            <div
              class="animalCard__animalName"
              @click="onPetModifyClick(animal.id)"
            >
            ...
            <button
              class="animalCard__animalAlertDelete"
              @click="deleteMyPet(animal.id)"
            >
              X
            </button>
          </div>
        ...
        <section>
          <form method="POST" id="account">
            <RouterLink
              to="/animal/tous-les-animaux"
              rel="noopener noreferrer"
              class="backButtonBlue"
              v-if="cardList"
            >
          ...
          <form method="POST" id="createAccount">
            <button
              class="yellowButton"
              @click="deleteAccount(localStorage.id)"
            >
